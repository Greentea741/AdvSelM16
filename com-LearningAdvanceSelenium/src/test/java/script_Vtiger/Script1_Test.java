...
public void script1()  throws EncryptedDocumentException, IOException, InterruptedException {
	...
	assertEquals(op.getGetCreateOrgnText().isDisplayed(), true, "create orgn text not displayed");
	...
	assertEquals(ele.getAttribute("value"), data,"data entered not matching");
